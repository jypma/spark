...
public class AlarmDecoderTest {
  ...
  public void motion_sensor_sequence_is_decoded() {
    ...
    assertEquals(new VisonicPacket(0x0E, 0xCF, 0xD5, 0xEF, 0x38), decoder.getResult());
  }
  ...
  public void motion_sensor_sequence_2_is_decoded() {
    ...
    assertEquals(new VisonicPacket(0x06, 0xCF, 0xD5, 0xEF, 0x38), decoder.getResult());
  }
  ...
  public void motion_sensor_B_sequence_1_is_decoded() {
    ...
    assertEquals(new VisonicPacket(0x02, 0xC4, 0x83, 0x8b, 0xb6), decoder.getResult());
  }
